...
function initPageReveal() {
  const revealItems = [
    ...document.querySelectorAll(
      '.alt-site-header, .hero-card, .about-section__label, .about-section__copy, .about-section__media, .portfolio-section__label, .portfolio-section h2, .portfolio-work-card'
    ),
  ];
